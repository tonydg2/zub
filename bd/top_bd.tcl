...
proc create_root_design { parentCell } {
  ...
  set emio_i2c0_scl_i_0 [ create_bd_port -dir I emio_i2c0_scl_i_0 ]
  set emio_i2c0_sda_t_0 [ create_bd_port -dir O emio_i2c0_sda_t_0 ]
  set emio_i2c0_sda_i_0 [ create_bd_port -dir I emio_i2c0_sda_i_0 ]
  set emio_i2c0_sda_o_0 [ create_bd_port -dir O emio_i2c0_sda_o_0 ]
  set emio_i2c1_scl_t_0 [ create_bd_port -dir O emio_i2c1_scl_t_0 ]
  set emio_i2c1_sda_i_0 [ create_bd_port -dir I emio_i2c1_sda_i_0 ]
  set emio_i2c1_scl_i_0 [ create_bd_port -dir I emio_i2c1_scl_i_0 ]
  set emio_i2c1_scl_o_0 [ create_bd_port -dir O emio_i2c1_scl_o_0 ]
  set emio_i2c0_scl_o_0 [ create_bd_port -dir O emio_i2c0_scl_o_0 ]
  ...
  set_property -dict [list \
    ...
    CONFIG.PSU_MIO_TREE_PERIPHERALS {Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Feedback Clk#GPIO0 MIO#GPIO0 MIO#GPIO0 MIO#UART 0#UART 0#GPIO0 MIO#SD 0#SD\
0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#GPIO0 MIO#GPIO0 MIO#PMU GPI 0#DPAUX#DPAUX#DPAUX#DPAUX#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#PMU GPO 2#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#SPI 0#GPIO1 MIO#GPIO1 MIO#SPI\
0#SPI 0#SPI 0#GPIO1 MIO#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#Gem 2#Gem 2#Gem 2#Gem 2#Gem 2#Gem 2#Gem 2#Gem 2#Gem 2#Gem 2#Gem 2#Gem 2#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB\
1#MDIO 2#MDIO 2} \
    CONFIG.PSU_MIO_TREE_SIGNALS {sclk_out#miso_mo1#mo2#mo3#mosi_mi0#n_ss_out#clk_for_lpbk#gpio0[7]#gpio0[8]#gpio0[9]#rxd#txd#gpio0[12]#sdio0_data_out[0]#sdio0_data_out[1]#sdio0_data_out[2]#sdio0_data_out[3]#sdio0_data_out[4]#sdio0_data_out[5]#sdio0_data_out[6]#sdio0_data_out[7]#sdio0_cmd_out#sdio0_clk_out#sdio0_bus_pow#gpio0[24]#gpio0[25]#gpi[0]#dp_aux_data_out#dp_hot_plug_detect#dp_aux_data_oe#dp_aux_data_in#gpio1[31]#gpio1[32]#gpio1[33]#gpo[2]#gpio1[35]#gpio1[36]#gpio1[37]#sclk_out#gpio1[39]#gpio1[40]#n_ss_out[0]#miso#mosi#gpio1[44]#sdio1_cd_n#sdio1_data_out[0]#sdio1_data_out[1]#sdio1_data_out[2]#sdio1_data_out[3]#sdio1_cmd_out#sdio1_clk_out#rgmii_tx_clk#rgmii_txd[0]#rgmii_txd[1]#rgmii_txd[2]#rgmii_txd[3]#rgmii_tx_ctl#rgmii_rx_clk#rgmii_rxd[0]#rgmii_rxd[1]#rgmii_rxd[2]#rgmii_rxd[3]#rgmii_rx_ctl#ulpi_clk_in#ulpi_dir#ulpi_tx_data[2]#ulpi_nxt#ulpi_tx_data[0]#ulpi_tx_data[1]#ulpi_stp#ulpi_tx_data[3]#ulpi_tx_data[4]#ulpi_tx_data[5]#ulpi_tx_data[6]#ulpi_tx_data[7]#gem2_mdc#gem2_mdio_out}\
\
    ...
    CONFIG.PSU__CRF_APB__DP_AUDIO_REF_CTRL__ACT_FREQMHZ {9.259259} \
    CONFIG.PSU__CRF_APB__DP_AUDIO_REF_CTRL__DIVISOR0 {42} \
    CONFIG.PSU__CRF_APB__DP_AUDIO_REF_CTRL__DIVISOR1 {1} \
    CONFIG.PSU__CRF_APB__DP_AUDIO_REF_CTRL__SRCSEL {RPLL} \
    CONFIG.PSU__CRF_APB__DP_AUDIO__FRAC_ENABLED {0} \
    CONFIG.PSU__CRF_APB__DP_STC_REF_CTRL__ACT_FREQMHZ {9.971510} \
...
\
  ...
  connect_bd_net -net axil_reg32_0_i2c_send_data  [get_bd_pins axil_reg32_0/i2c_send_data] \
  [get_bd_ports i2c_send_data_o]
  connect_bd_net -net axil_reg32_0_led_div0_o  [get_bd_pins axil_reg32_0/led_div0_o] \
  [get_bd_pins led_cnt_vhd19_0/div_i]
  connect_bd_net -net axil_reg32_0_led_div1_o  [get_bd_pins axil_reg32_0/led_div1_o] \
  [get_bd_ports led_div1_o_0]
  connect_bd_net -net emio_i2c0_scl_i_0_1  [get_bd_ports emio_i2c0_scl_i_0] \
  [get_bd_pins zynq_ultra_ps_e_0/emio_i2c0_scl_i]
  connect_bd_net -net emio_i2c0_sda_i_0_1  [get_bd_ports emio_i2c0_sda_i_0] \
  [get_bd_pins zynq_ultra_ps_e_0/emio_i2c0_sda_i]
  connect_bd_net -net emio_i2c1_scl_i_0_1  [get_bd_ports emio_i2c1_scl_i_0] \
  [get_bd_pins zynq_ultra_ps_e_0/emio_i2c1_scl_i]
  connect_bd_net -net emio_i2c1_sda_i_0_1  [get_bd_ports emio_i2c1_sda_i_0] \
  [get_bd_pins zynq_ultra_ps_e_0/emio_i2c1_sda_i]
  connect_bd_net -net git_hash_top_0_1  [get_bd_ports git_hash_top] \
  [get_bd_pins axil_reg32_0/git_hash_top]
  ...
  [get_bd_pins axil_reg32_0/S_AXI_ARESETN]
  ...
  connect_bd_net -net timstamp_top_0_1  [get_bd_ports timstamp_top] \
  [get_bd_pins axil_reg32_0/timstamp_top]
  connect_bd_net -net user_init_64b_wrappe_0_usr_access_data_o  [get_bd_pins user_init_64b_wrappe_0/usr_access_data_o] \
  [get_bd_pins axil_reg32_0/timstamp_bd]
  connect_bd_net -net user_init_64b_wrappe_0_value_o  [get_bd_pins user_init_64b_wrappe_0/value_o] \
  [get_bd_pins axil_reg32_0/git_hash_bd]
  connect_bd_net -net xlconstant_0_dout  [get_bd_pins xlconstant_0/dout] \
  [get_bd_pins led_cnt_vhd19_0/wren_i]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_i2c0_scl_o  [get_bd_pins zynq_ultra_ps_e_0/emio_i2c0_scl_o] \
  [get_bd_ports emio_i2c0_scl_o_0]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_i2c0_scl_t  [get_bd_pins zynq_ultra_ps_e_0/emio_i2c0_scl_t] \
  [get_bd_ports emio_i2c0_scl_t_0]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_i2c0_sda_o  [get_bd_pins zynq_ultra_ps_e_0/emio_i2c0_sda_o] \
  [get_bd_ports emio_i2c0_sda_o_0]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_i2c0_sda_t  [get_bd_pins zynq_ultra_ps_e_0/emio_i2c0_sda_t] \
  [get_bd_ports emio_i2c0_sda_t_0]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_i2c1_scl_o  [get_bd_pins zynq_ultra_ps_e_0/emio_i2c1_scl_o] \
  [get_bd_ports emio_i2c1_scl_o_0]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_i2c1_scl_t  [get_bd_pins zynq_ultra_ps_e_0/emio_i2c1_scl_t] \
  [get_bd_ports emio_i2c1_scl_t_0]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_i2c1_sda_o  [get_bd_pins zynq_ultra_ps_e_0/emio_i2c1_sda_o] \
  [get_bd_ports emio_i2c1_sda_o_0]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_i2c1_sda_t  [get_bd_pins zynq_ultra_ps_e_0/emio_i2c1_sda_t] \
  [get_bd_ports emio_i2c1_sda_t_0]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0  [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] \
  [get_bd_ports clk100] \
  [get_bd_pins led_cnt_vhd19_0/clk] \
  [get_bd_pins axil_reg32_0/S_AXI_ACLK] \
