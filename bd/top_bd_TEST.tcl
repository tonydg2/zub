...
# module references:
# axil_reg32, user_init_64b_wrapper_zynq, led_cnt_vhd19, axil_passthru
...
proc create_root_design { parentCell } {
  ...
  set M_AXI_GPIO_PL [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:aximm_rtl:1.0 M_AXI_GPIO_PL ]
  ...
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {M_AXI_GPIO_PL} \
 ] $clk100
  set rst [ create_bd_port -dir O -from 0 -to 0 -type rst rst ]
  set git_hash_common [ create_bd_port -dir I -from 63 -to 0 git_hash_common ]
  set timstamp_scripts [ create_bd_port -dir I -from 31 -to 0 timstamp_scripts ]
  set git_hash_scripts [ create_bd_port -dir I -from 63 -to 0 git_hash_scripts ]
  set timstamp_common [ create_bd_port -dir I -from 31 -to 0 timstamp_common ]
  ...
  set gpio2_o [ create_bd_port -dir O -from 2 -to 0 gpio2_o ]
  ...
  set ps_pl_irq_i2c0_0 [ create_bd_port -dir O -type intr ps_pl_irq_i2c0_0 ]
  ...
  set_property -dict [list \
    ...
    CONFIG.PSU_MIO_TREE_PERIPHERALS {Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Quad SPI Flash#Feedback Clk#GPIO0 MIO#I2C 1#I2C 1#UART 0#UART 0#GPIO0 MIO#SD 0#SD 0#SD 0#SD\
0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#SD 0#GPIO0 MIO#GPIO0 MIO#PMU GPI 0#DPAUX#DPAUX#DPAUX#DPAUX#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#PMU GPO 2#GPIO1 MIO#GPIO1 MIO#GPIO1 MIO#SPI 0#GPIO1 MIO#GPIO1 MIO#SPI 0#SPI 0#SPI\
0#GPIO1 MIO#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#SD 1#Gem 2#Gem 2#Gem 2#Gem 2#Gem 2#Gem 2#Gem 2#Gem 2#Gem 2#Gem 2#Gem 2#Gem 2#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#USB 1#MDIO 2#MDIO\
2} \
...
\
    ...
    CONFIG.PSU__IRQ_P2F_I2C0__INT {1} \
...
\
  ...
  # Create instance: gpio_pl, and set properties
  set block_name axil_passthru
  set block_cell_name gpio_pl
  if { [catch {set gpio_pl [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $gpio_pl eq "" } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2096 -severity "ERROR" "Unable to referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
  ...
  connect_bd_net -net git_hash_scripts_0_1 [get_bd_ports git_hash_scripts] [get_bd_pins axil_reg32_0/git_hash_scripts]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_emio_i2c0_scl_o [get_bd_pins zynq_ultra_ps_e_0/emio_i2c0_scl_o] [get_bd_ports emio_i2c0_scl_o_0]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_i2c0_scl_t [get_bd_pins zynq_ultra_ps_e_0/emio_i2c0_scl_t] [get_bd_ports emio_i2c0_scl_t_0]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_i2c0_sda_o [get_bd_pins zynq_ultra_ps_e_0/emio_i2c0_sda_o] [get_bd_ports emio_i2c0_sda_o_0]
  connect_bd_net -net zynq_ultra_ps_e_0_emio_i2c0_sda_t [get_bd_pins zynq_ultra_ps_e_0/emio_i2c0_sda_t] [get_bd_ports emio_i2c0_sda_t_0]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_ps_pl_irq_i2c0 [get_bd_pins zynq_ultra_ps_e_0/ps_pl_irq_i2c0] [get_bd_ports ps_pl_irq_i2c0_0]
  ...
  exclude_bd_addr_seg -offset 0x00000000 -range 0x00000200 -target_address_space [get_bd_addr_spaces gpio_pl/M_AXI] [get_bd_addr_segs M_AXI_GPIO_PL/Reg]
